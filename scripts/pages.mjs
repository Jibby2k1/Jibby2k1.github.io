  ...
  return `<div class="container cv-shell">
    ...
    <section class="accent-amber">
      ...
      <article class="card reveal">
        ...
        <ul class="cv-list">
          <li>EEG-based sentiment and brain-state tracking on the Sony–UF "LB3" dataset: state-space modeling (Hierarchical Linear Dynamical Systems) that turns raw EEG into compact hidden time-series states evaluated for prediction and separability.</li>
